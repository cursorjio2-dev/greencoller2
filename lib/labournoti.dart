...
//
// class LabourNotification extends StatefulWidget {
//   @override
//   _LabourNotificationState createState() => _LabourNotificationState();
// }
//
// class _LabourNotificationState extends State<LabourNotification> {
...
//     final response = await http.post(
//       Uri.parse('${Constants.AppConstants.apiUrl}farmer/labournotifications'),
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: Constants.AppTypography.h3
              .copyWith(color: Constants.AppColors.card),
        ),
        iconTheme: const IconThemeData(color: Constants.AppColors.card),
        flexibleSpace: Container(
          decoration: const BoxDecoration(
        ...
        child: isLoading
          ...
          child: Text(
            ...
            style: Constants.AppTypography.body
                .copyWith(color: Constants.AppColors.inkSoft),
          ),
        )
            : ListView.builder(
          padding: const EdgeInsets.symmetric(vertical: 8),
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    translateText(notification['message']),
                    style: Constants.AppTypography.body
                        .copyWith(color: Constants.AppColors.ink),
                  ),
                  subtitle: Padding(
                    padding: const EdgeInsets.only(top: 4),
                    child: Text(
